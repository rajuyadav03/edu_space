        ...
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button 
              ...
              disabled
              title="Coming soon"
              className="flex items-center justify-center gap-2 px-4 py-3.5 border border-gray-300 dark:border-gray-600 rounded-xl font-medium text-gray-400 dark:text-gray-500 cursor-not-allowed opacity-60"
            >
