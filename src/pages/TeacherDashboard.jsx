              ...
              {loading ? (
                ...
                <div className="space-y-6">
                  {bookings.map((booking) => (
                    <div key={booking._id || booking.id} className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-6 flex gap-6 hover:bg-gray-100 dark:hover:bg-gray-800 transition">
                      <img 
                        ...
                        <div className="flex gap-3">
                          ...
                          {(booking.status === 'pending' || booking.status === 'Pending') && (
                            <button 
                              ...
                              className="px-6 py-2 border-2 border-gray-900 dark:border-gray-300 text-gray-900 dark:text-gray-300 rounded-xl font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition disabled:opacity-50"
                            >
