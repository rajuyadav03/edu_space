    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-neutral-950 pt-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
          ...
          {/* Tabs */}
          <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-gray-200 dark:border-neutral-800 overflow-hidden mb-8">
            <div className="border-b border-gray-200 dark:border-neutral-800 px-6">
              <div className="flex gap-8">
                <button
                  type="button"
                  onClick={() => setActiveTab("spaces")}
                  className={`py-4 border-b-2 font-semibold transition ${activeTab === "spaces"
                ...
                <button
                  ...
                  className={`py-4 border-b-2 font-medium transition ${activeTab === "requests"
                      ? "border-gray-900 dark:border-white text-gray-900 dark:text-white"
                      : "border-transparent text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
                    }`}
                >
                ...
                <button
                  ...
                  className={`py-4 border-b-2 font-medium transition ${activeTab === "settings"
                      ? "border-gray-900 dark:border-white text-gray-900 dark:text-white"
                      : "border-transparent text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
                    }`}
                >
              ...
              {activeTab === "spaces" && (
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {mySpaces.map((space) => (
                      <div key={space._id || space.id} className="bg-gray-50 dark:bg-neutral-900/50 rounded-2xl overflow-hidden hover:bg-gray-100 dark:hover:bg-neutral-900 transition">
                        <img
                          src={space.image}
                          alt={space.name}
                        ...
                        <div className="p-6">
                          ...
                          <div className="grid grid-cols-3 gap-4 mb-4 py-4 border-y border-gray-200 dark:border-neutral-800">
                            <div>
                          ...
                          <div className="flex gap-3">
                            ...
                            <button
                              ...
                              className="flex-1 px-4 py-2 border-2 border-gray-900 dark:border-gray-300 text-gray-900 dark:text-gray-300 rounded-xl font-semibold hover:bg-gray-50 dark:hover:bg-neutral-800 transition"
                            >
                              View
                            </button>
                            <button
              ...
              {activeTab === "requests" && (
                <>
                  {loading ? (
                    <div className="space-y-4">
                      {[1, 2].map((n) => (
                        <div key={n} className="bg-gray-50 dark:bg-neutral-900/50 rounded-2xl p-6 animate-pulse">
                          <div className="flex items-center gap-4 mb-3">
                            <div className="w-12 h-12 bg-gray-200 dark:bg-neutral-800 rounded-full" />
                    ...
                    <div className="space-y-4">
                      {pendingRequests.filter(r => r.status === 'pending' || r.status === 'Pending').map((request) => (
                        <div key={request._id || request.id} className="bg-gray-50 dark:bg-neutral-900/50 rounded-2xl p-6 flex items-center justify-between hover:bg-gray-100 dark:hover:bg-neutral-900 transition">
